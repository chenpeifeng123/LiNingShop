...
$db = mysqli_connect("127.0.0.1", "root", "root", "suningshengxian");
$type = $_REQUEST["type"];
$id = $_REQUEST["id"];
...
if($type == "add")
{
  ...
  $sql = "SELECT cart.*,goods.title,goods.src,goods.shopName,goods.price FROM cart , goods WHERE cart.good_id = goods.good_id AND id=$id";
